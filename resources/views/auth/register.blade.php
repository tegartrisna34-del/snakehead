        ...
        <div class="glass auth-card overflow-hidden">
            <div class="p-8 pb-5">
                <div class="text-center mb-6">
                    ...
                    <h1 class="text-xl font-bold font-syne tracking-tight mb-2 uppercase italic">Initialize <span class="text-emerald-500">Portal</span></h1>
                    <p class="text-[0.8rem] text-gray-500 font-medium">Join the elite collector sanctuary.</p>
                </div>
                ...
                <form action="{{ route('register') }}" method="POST" class="space-y-3">
                    ...
                    <div class="space-y-1">
                        <label class="text-[9px] font-bold uppercase tracking-[0.2em] text-gray-500 ml-1">Full Name</label>
                    ...
                    <div class="space-y-1">
                        <label class="text-[9px] font-bold uppercase tracking-[0.2em] text-gray-500 ml-1">Access Key</label>
                    ...
                    <div class="space-y-1">
                        <label class="text-[9px] font-bold uppercase tracking-[0.2em] text-gray-500 ml-1">Confirm Access Key</label>
                        <input type="password" name="password_confirmation" required 
                            class="input-field w-full px-5 py-3.5 rounded-xl outline-none text-[0.85rem] text-white placeholder-gray-600" 
                            placeholder="••••••••">
                    </div>

                    <button type="submit" class="btn-premium w-full py-4 text-[0.8rem] font-extrabold uppercase tracking-[0.2em] rounded-xl flex items-center justify-center space-x-2 mt-2">
            ...
            <div class="px-8 py-6 text-center bg-black/20">
                <div class="flex flex-col items-center space-y-2">
                    ...
                    <div class="px-3 py-1 bg-emerald-500/10 border border-emerald-500/20 rounded-full">
                        <p class="text-[7.5px] font-black text-emerald-500 uppercase tracking-[0.2em]">Deployment Ready</p>
                    </div>
                </div>
            </div>
        </div>
